  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="Overview" component={OverviewScreen} options={{ headerShown: true, title: 'OverView' }} />
        <Stack.Screen name="AddTransaction" component={AddTransactionScreen} options={{ headerShown: true, title: 'Log Transactions' }} />
